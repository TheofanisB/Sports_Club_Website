	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         <li class="nav-item "><a href="index.php" class="nav-link">Home</a></li>
	          ...
	          <li class="nav-item active"><a href="about.php" class="nav-link">Members</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Members</h1>
    ...
    <section class="ftco-section ftco-team img" style="background-image:url(images/bg_3.jpg);" data-stellar-background-ratio="0.5">
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section heading-section-white text-center ftco-animate">
          	<span class="subheading">Our Directors</span>
            <h2 class="mb-4">Our  <span>Staff</span></h2>
            <p>From the depths of the Aegean to the fields of Fournoi</p>
          </div>
        </div>
    		<div class="row">
    			<div class="col-md-12 ftco-animate">
    				...
    				<div class="item">
    					<div class="team-wrap text-center">
		    				...
		    				<div class="text">
		    					<h3 class="mb-0">Joe Doe</h3>
		    					<span class="position">Executive Chairman</span>
		    				</div>
	    				</div>
    				</div>
    				<div class="item">
    					<div class="team-wrap text-center">
		    				...
		    				<div class="text">
		    					<h3 class="mb-0">Marios Pentagiotis</h3>
    				...
    				<div class="item">
    					<div class="team-wrap text-center">
		    				...
		    				<div class="text">
		    					<h3 class="mb-0">Babis Sougias</h3>
    				...
    				<div class="item">
    					<div class="team-wrap text-center">
		    				...
		    				<div class="text">
		    					<h3 class="mb-0">Mike Green</h3>
		    					<span class="position">Independent Director</span>
		    				</div>
	    				</div>
    				</div>
