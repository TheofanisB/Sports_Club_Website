			...
			<div class="container">
				<div >
					...
					<div class="col-md-4 sidebar">
                        ...
                        <?php
									$sql2 = "select SUM(score1) from game ";
									if ($result = mysqli_query($link, $sql2)) {
									?>


                            <h3 >Total Team Score </h3>
                            ><?php echo $row['SUM(score1)']; ?>
						...
						<div class="row block-9">
							<div class="col-md-6 order-md-last d-flex">
								<form action="submit_game.php"  method="post"  class="bg-light p-5 contact-form">
									...
									<div class="form-group">
										<textarea name="date" type="text"   id="date" cols="30" rows="2" class="form-control" placeholder="Date(yyyy-mm-dd)"></textarea>
									</div>
									<div class="form-group">
